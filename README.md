...
|[Thermostat](http://tomy8s.herokuapp.com/projects/thermostat) \| [source](https://github.com/Tomy8s/thermostat) | **JavaScript**, **JQuery**, **AJAX**, **Jasmine**, **JSON** | Learning another language, prototypal languages |  
